...
namespace Spark\Extension\Loader;

use Composer\Autoload\ClassLoader;
use Spark\Extension\Exception\ExtenesionLoaderException;
use Spark\Extension\ExtensionInterface;
use Spark\Extension\ExtensionType;
use function assert;
